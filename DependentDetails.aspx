<%@ Page language="c#" Inherits="insurancenew.DependentDetails" CodeFile="DependentDetails.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<meta name="vs_showGrid" content="False">
		<title>DependentDetails</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:DataGrid id="DataGrid2" style="Z-INDEX: 101; LEFT: -4px; POSITION: absolute; TOP: 24px" runat="server"
