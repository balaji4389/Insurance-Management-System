...
{
	/// <summary>
	/// Summary description for customer_prem_details.
	/// </summary>
	public partial class customer_prem_details : System.Web.UI.Page
	{
...
//		SqlCommand cm;
		...
		{	string  j;
			j=Convert.ToString (DataGrid1.Items[DataGrid1.SelectedIndex].Cells[0].Text);
			Session["cust_policy_no"]=j.ToString();
            Server.Transfer("NomineeDetails.aspx");
		}
